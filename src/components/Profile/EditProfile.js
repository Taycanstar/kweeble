            ...
            <div className="left-form-part">
              ...
              <form className="edit-profile-form" onSubmit={onSubmit}>
                ...
                <div className="bday-body">
                  <label className="birthday-label-profile" htmlFor="birthday">
                    Date of birth
                  </label>
                  <div className="birthday-wrapper-profile">
                    <div className="birthday-profile">
                      <select
                        className="signup-select-profile"
                        name="birthDay"
                        id="birth_day"
                        onChange={(e) =>
                ...
                <input
                  ...
                  type="text"
                />
                <h3 className="top-label">Grade Level</h3>
                <input
                  name="gradeLevel"
